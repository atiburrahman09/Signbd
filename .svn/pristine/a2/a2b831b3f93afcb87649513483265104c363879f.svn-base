...
{
    public partial class ChequeUse : System.Web.UI.Page
    {
        ...
        protected void useLinkButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    string message = "Cheque <span class='actionTopic'>Used</span> Successfully.";
