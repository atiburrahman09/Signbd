...
{
    public partial class PendingTransferOrderCancelRequestList : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                GetTransferOrderCancelRequestList();
            }
        ...
        protected void rejectLinkButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                productTransferOrder.UpdateProductTransferOrderStatusById(transferOrderListGridView.Rows[row.RowIndex].Cells[0].Text.ToString(), "P");

                MyAlertBox("alert(\"Product Transfer Order [" + transferOrderListGridView.Rows[row.RowIndex].Cells[0].Text.ToString() + "] Cancel Request Rejected Successfully.\"); window.location=\"/UI/ProductTransferOrder/PendingTransferOrderCancelRequestList.aspx\"");
            }
            catch (Exception ex)
            {
                msgbox.Visible = true; msgTitleLabel.Text = "Exception!!!"; msgDetailLabel.Text = ex.Message;
        ...
        protected void GetTransferOrderCancelRequestList()
        {
            ProductTransferOrderBLL productTransferOrder = new ProductTransferOrderBLL();
            ...
            try
            {
                ...
                else
                {
                    ...
                    DataTable dt = productTransferOrder.GetProductTransferOrdersListByTransferDescriptionTypeFromToAndStatus(transferDescription, transferType, transferFrom, transferTo, "CP");
