...
{
    public partial class SalesOrderDelivery : System.Web.UI.Page
    {
        ...
        protected void viewToDeliverLinkButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                LumexSessionManager.Add("SalesOrderIdForDeliver", pendingSalesOrderListGridView.Rows[row.RowIndex].Cells[0].Text.ToString());
                Response.Redirect("~/UI/SalesOrder/DeliverSalesOrder.aspx");
            }
            catch (Exception ex)
            {
                msgbox.Visible = true; msgTitleLabel.Text = "Exception!!!"; msgDetailLabel.Text = ex.Message;
