                    ...
                    <div class="widget-body no-padding">
                        <div class="grid-12">
                            <div class="widget-separator no-border grid-3">
                                ...
                                <asp:DropDownList ID="warehouseDropDownList" required="required" runat="server" OnSelectedIndexChanged="btnVendorList_Click" AutoPostBack="True" CssClass="form form-full">
                                </asp:DropDownList>
                            </div>
