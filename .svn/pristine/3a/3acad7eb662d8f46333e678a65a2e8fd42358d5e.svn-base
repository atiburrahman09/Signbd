    ...
    public partial class Update : System.Web.UI.Page
    {
        ...
        protected void productTypeDropDownList_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    subProductDropDownList.Enabled = false;
                    mainProductListListBox.Enabled = false;
                    //txtBxAddition.Focus();
                }
        ...
        protected void btnAdd_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                for (int i = 0; i < mainProductListListBox.Items.Count; i++)
                {
                    if (mainProductListListBox.Items[i].Value == subProductDropDownList.SelectedValue)
                    {
                        getmatch = 1;
                        return;
                    }
                ...
                if (getmatch == 0)
                {
                    mainProductListListBox.Items.Add(new ListItem(subProductDropDownList.SelectedItem.Text, subProductDropDownList.SelectedItem.Value));
                    //   subProductDropDownList.SelectedIndex = subProductDropDownList.Items.Count - 1;
                }
        ...
        protected void warehouseDropDownList_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            LoadProductGroups();
            LoadVendors();
        }
