                                    ...
                                    <div class="accordion-inner" style="padding: 0;">
                                        <div id="orderInfoContainer">
                                            <div class="grid-12">
                                                ...
                                                <div class="widget-separator grid-6">
                                                    <div class="grid-4">
                                                        <asp:Label ID="salesCenterOrWareHouseIdLabel" runat="server" Text="Business ID:"></asp:Label>
                                                ...
                                                <div class="widget-separator grid-6">
                                                    <div class="grid-4">
                                                        <asp:Label ID="salesCenterOrWareHouseNameLabel" runat="server" Text="Business Name:"></asp:Label>
