...
namespace lmxIpos.UI.Sales
{
    public partial class RetailSales : System.Web.UI.Page
    {
        ...
        private void getCustomerTotalReceivableByCustomerId()
        {
            ...
            try
            {
                DataTable dt = receivePayment.GetCustomerTotalReceivable(customerIdDropDownList.SelectedValue, (string)LumexSessionManager.Get("UserSalesCenterId"));
        ...
        protected void saveButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else if (customerIdDropDownList.SelectedItem.Text.Trim() == "Retail" && Convert.ToDecimal(receivableAmountTextBox.Text) > Convert.ToDecimal(receivedAmountTextBox.Text) && customerNameTextBox.Text == "")
                {
