...
namespace lmxIpos.UI.Customer
{
    public partial class List : System.Web.UI.Page
    {
        ...
        protected void btnCustoemrList_Click(object sender, EventArgs e)
        {
            GetCustomerListByWareHouseId();
        }
        ...
        protected void editLinkButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                LumexSessionManager.Add("CustomerIdForUpdate", customerListGridView.Rows[row.RowIndex].Cells[0].Text.ToString());
                Response.Redirect("~/UI/Customer/Update.aspx", false);
            }
            catch (Exception ex)
            {
                string message = ex.Message;
        ...
        protected void activateLinkButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                CustomerBLL customer = new CustomerBLL();
                customer.UpdateCustomerActivation(customerListGridView.Rows[row.RowIndex].Cells[0].Text.ToString(), "True");

                customerListGridView.Rows[row.RowIndex].Cells[5].Text = "True";
                string message = "Customer <span class='actionTopic'>Activated</span> Successfully.";
