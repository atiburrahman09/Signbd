...
namespace Lumex.Project.BLL
{
    public class SalesCenterBLL
    {
        ...
        public DataTable getTotalCashCreditSalesByDateRange(string startdate, string EndDate, string SalesCenter)
        {
            SalesCenterDAL salesCenter = new SalesCenterDAL();
            ...
            {
                LumexDBPlayer db = LumexDBPlayer.Start();
                DataTable dt = salesCenter.getTotalCashCreditSalesByDateRange(startdate, EndDate, SalesCenter, db);
                db.Stop();
