...
namespace lmxIpos.UI.PurchaseOrder
{
    public partial class PurchaseOrderList : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                LoadWarehouses();
                //fromDateTextBox.Text = LumexLibraryManager.GetAppDateEdit(DateTime.Today.ToString());
                //toDateTextBox.Text = LumexLibraryManager.GetAppDateEdit(DateTime.Today.ToString());
            }
