    ...
    public partial class DeletedList : System.Web.UI.Page
    {
        ...
        protected void viewLinkButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                LumexSessionManager.Add("WarehouseIdForView", deletedListGridView.Rows[row.RowIndex].Cells[0].Text.ToString());
                Response.Redirect("~/UI/business/View.aspx", false);
            }
            catch (Exception ex)
            {
                string message = ex.Message;
        ...
        protected void deletedListButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    DataTable dt = warehouse.GetDeletedWarehouseListByDateRangeAll(fromDate, toDate, "");
                    ...
                    {
                        msgbox.Visible = true; msgTitleLabel.Text = "Deleted Warehouse List Data Not Found!!!"; msgDetailLabel.Text = "";
        ...
        protected void GetAllDeletedList()
        {
            ...
            try
            {
                ...
                DataTable dt = warehouse.GetDeletedWarehouseListByDateRangeAll(fromDate, toDate, "All");
