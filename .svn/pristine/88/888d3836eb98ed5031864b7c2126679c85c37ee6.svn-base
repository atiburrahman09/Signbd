<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true"
    CodeBehind="DeletedList.aspx.cs" Inherits="lmxIpos.UI.SalesPerson.DeletedList" %>
    ...
    <asp:UpdatePanel runat="server" ID="UpdatePanel1" UpdateMode="Conditional" ChildrenAsTriggers="false">
        <ContentTemplate>
            <div class="title-sitemap grid-12">
                <h1 class="grid-6">
                    <i>&#xf132;</i>Deleted Sales Person<span>Deleted Sales Person List of System</span></h1>
                            ...
                            <div id="deletedListGridContainer">
                                <asp:GridView ID="deletedListGridView" runat="server" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="SalesPersonName" HeaderText="Name" />
