<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true"
    CodeBehind="TransferOrderCancelRequest.aspx.cs" Inherits="lmxIpos.UI.ProductTransferOrder.TransferOrderCancelRequest" %>
    ...
    <asp:UpdatePanel runat="server" UpdateMode="Conditional" ID="UpdatePanel1" ChildrenAsTriggers="true">
        <ContentTemplate>
            <div class="title-sitemap grid-12">
                <h1 class="grid-9">
                    <i>&#xf132;</i>Product Transfer Order Cancel Request<span>Created Product Transfer Order
                        Cancel Request</span></h1>
                ...
                <div class="widget">
                    <header class="widget-header">
                        ...
                        <h3 id="Header3" runat="server" class="widget-header-title">
                            Product Transfer Order Cancel Request of System</h3>
                    </header>
                                        ...
                                        <asp:TemplateField HeaderText="">
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton ID="cancelRequestLinkButton" runat="server" CssClass="btn btn-mini btn-success"
                                                    Width="105" OnClick="cancelRequestLinkButton_Click" OnClientClick="return confirm('Are you sure you want to cancel the transfer order?');">Request to Cancel</asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
