<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true"
    CodeBehind="UpdateUsedCheque.aspx.cs" Inherits="lmxIpos.UI.AccUI.BankChequeBook.UpdateUsedCheque" %>

<asp:Content ID="headContent" ContentPlaceHolderID="headContentPlaceHolder" runat="server">
    <link href="/Content/Style/CSSPages/UpdateUsedCheque.css" rel="stylesheet" type="text/css" />
</asp:Content>
    ...
    <asp:UpdatePanel runat="server" ID="UpdatePanel1">
        <ContentTemplate>
            <div class="title-sitemap grid-12">
                <h1 class="grid-6">
                    <i>&#xf132;</i>Update Used Cheque<span>Updating Used Cheque</span></h1>
                ...
                <div class="widget">
                    <header class="widget-header">
                        ...
                        <h3 id="Header3" runat="server" class="widget-header-title">
                            Update Used Cheque of System</h3>
                    </header>
                                    ...
                                    <asp:GridView ID="chequeBookPageListGridView" runat="server" AutoGenerateColumns="false"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="updateLinkButton" runat="server" CssClass="btn btn-mini btn-warning clickProcessing"
        ...
        $(function () {
            $(".clickProcessing").live("click", function (e) {
                if (haveOverlay == 0) {
                    ...
                    if (id == "updateLinkButton") {
                        msg = "Are you sure you want to <span class='actionTopic'>update</span> this cheque?";
                    }
