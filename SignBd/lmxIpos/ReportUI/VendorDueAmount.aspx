<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true" CodeBehind="VendorDueAmount.aspx.cs" Inherits="lmxIpos.ReportUI.VendorDueAmount" EnableEventValidation="false"%>
    ...
    <asp:UpdatePanel runat="server" ID="UpdatePanel1">
        <ContentTemplate>
            <div class="title-sitemap grid-12">
                <h1 class="grid-8">
                    <i>&#xf132;</i>Vendor Due Amount<span>Viewing Vendor Due Amount Report</span></h1>
