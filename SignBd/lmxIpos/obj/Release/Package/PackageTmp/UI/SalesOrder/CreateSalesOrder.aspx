                                ...
                                <asp:GridView ID="selectedProductListGridView" runat="server" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Rate">
                                            <ItemTemplate>
                                                <asp:TextBox ID="ratePerUnitTextBox" runat="server" Width="50" CssClass="oQty-rpu-amt-cal autoCompeleteOff"></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                        ...
                        <div class="widget-separator no-padding grid-12">
                            <div class="grid-6" style="float: right;">
                                ...
                                <div class="widget-separator no-border grid-12">
                                    ...
                                    <div class="grid-2">
                                        <asp:CompareValidator ID="CompareValidator3" runat="server" ErrorMessage="*" ControlToValidate="discountTextBox"
                                            ValidationGroup="2" Type="Currency" Operator="DataTypeCheck" ForeColor="Red"
                                            Visible="true"> </asp:CompareValidator>
                                    </div>
                                </div>
                                <div class="widget-separator no-border grid-12">
                                    ...
                                    <div class="grid-2">
                                        <%-- <asp:CompareValidator ID="CompareValidator4" runat="server" ErrorMessage="*" Text="0.00" onfocus="this.select();" ControlToValidate="receivedAmountTextBox"
                                            ValidationGroup="2" Type="Currency" Operator="DataTypeCheck" ForeColor="Red"
                                            Visible="true"> </asp:CompareValidator>--%>
                                        <asp:CompareValidator ID="CompareValidator5" runat="server" ErrorMessage="*" ControlToValidate="vatTextBox"
                                            ValidationGroup="2" Type="Currency" Operator="DataTypeCheck" ForeColor="Red"
                                            Visible="true"> </asp:CompareValidator>
                                    </div>
                                </div>
                                ...
                                <div class="widget-separator no-border grid-12">
                                    <div class="grid-7">
                                        <h5 class="typo" style="float: right;">Received (Cash / Cheque)&nbsp;&nbsp;&nbsp;</h5>
                                    </div>
                                    <div class="grid-3">
