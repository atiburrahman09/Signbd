<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true"
    CodeBehind="PendingSalesOrderList.aspx.cs" Inherits="lmxIpos.UI.SalesOrder.PendingSalesOrderList" EnableEventValidation="false"  %>
    ...
    <asp:UpdatePanel runat="server" UpdateMode="Conditional" ID="UpdatePanel1" ChildrenAsTriggers="false">
        <ContentTemplate>
            <div class="title-sitemap grid-12">
                <h1 class="grid-7">
                    <i>&#xf132;</i>Pending Sales Order List<span>Pending Sales Order List</span></h1>
                ...
                <div class="widget">
                    <header class="widget-header">
                        ...
                        <h3 id="Header3" runat="server" class="widget-header-title">
                            System of Pending Sales Order List</h3>
                    </header>
