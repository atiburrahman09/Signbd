<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true"
    CodeBehind="ApproveTransferRecord.aspx.cs" Inherits="lmxIpos.UI.ProductTransferRecord.ApproveTransferRecord" %>
                    ...
                    <div class="widget-body no-padding">
                        ...
                        <div class="widget-separator grid-12">
                            <asp:Button ID="approveButton" runat="server" Enabled="false" CssClass="btn btn-submit btn-3d"
                                Text="Approve Transfer Record" OnClick="approveButton_Click" />
                        </div>
                        <asp:HiddenField ID="productTransferRecordIdForApproveHiddenField" runat="server" />
                    </div>
                </div>
            </div>
        </ContentTemplate>
