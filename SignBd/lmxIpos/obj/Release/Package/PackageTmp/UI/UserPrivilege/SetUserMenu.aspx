            ...
            <div class="data">
                ...
                <div class="widget">
                    <header class="widget-header">
                        ...
                        <h3 id="Header3" runat="server" class="widget-header-title">Set User Menu</h3>
                    </header>
                                ...
                                <div id="userMenuPane" runat="server" visible="false">
                                    <div id="listPane" class="widget-separator grid-12">
                                        <div class="widget-separator no-border grid-5">
                                            ...
                                            <asp:ListBox ID="groupWiseMenuListListBox" runat="server" CssClass="form form-full"></asp:ListBox>
                                        ...
                                        <div class="widget-separator no-border grid-5">
                                            <h4>Group Wise User's Menu List</h4>
                                            <asp:ListBox ID="groupWiseUserMenuListListBox" runat="server" CssClass="form form-full"></asp:ListBox>
