<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true"
    CodeBehind="GetTransferOrderOnTransport.aspx.cs" Inherits="lmxIpos.UI.ProductTransferOrder.GetTransferOrderOnTransport" %>
    ...
    <asp:UpdatePanel runat="server" UpdateMode="Conditional" ID="UpdatePanel1" ChildrenAsTriggers="true">
        <ContentTemplate>
            <div class="title-sitemap grid-12">
                <h1 class="grid-9">
                    <i>&#xf132;</i>Get Product Transfer Order On Transport<span>System Get Product Transfer
                        Order On Transport</span></h1>
                ...
                <div class="widget">
                    <header class="widget-header">
                        ...
                        <h3 id="Header3" runat="server" class="widget-header-title">
                            Get Product Transfer Order On Transport of System</h3>
                    </header>
                                        ...
                                        <asp:TemplateField HeaderText="">
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton ID="setOnTransportLinkButton" runat="server" CssClass="btn btn-mini btn-success"
                                                    Width="105" OnClientClick="return confirm('Do you want to set this Transfer Order on transport?');"
