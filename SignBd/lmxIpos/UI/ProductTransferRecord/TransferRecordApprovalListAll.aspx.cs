...
{
    public partial class TransferRecordApprovalListAll : System.Web.UI.Page
    {
        ...
        protected void GetApprovalList()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    DataTable dt = productTransferRecord.GetProductTransferRecordsListByTransferDescriptionTypeFromToAndStatusAll();
