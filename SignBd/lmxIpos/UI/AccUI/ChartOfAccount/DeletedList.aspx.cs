    ...
    public partial class DeletedList : System.Web.UI.Page
    {
        ...
        protected void viewLinkButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                LumexSessionManager.Add("ChartOfAccountIdForView", deletedListGridView.Rows[row.RowIndex].Cells[0].Text.ToString());
        ...
        protected void GetAllDeletedList()
        {
            ...
            try
            {
                ...
                DataTable dt = chartOfAccount.GetDeletedChartOfAccountListByDateRangeAll(fromDate, toDate, "All");
