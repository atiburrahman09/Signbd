<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true"
    CodeBehind="DeletedList.aspx.cs" Inherits="lmxIpos.UI.AccUI.PayToFromCompany.DeletedList" %>
    ...
    <asp:UpdatePanel runat="server" ID="UpdatePanel1" UpdateMode="Conditional" ChildrenAsTriggers="true">
        <ContentTemplate>
            <div class="title-sitemap grid-12">
                <h1 class="grid-7">
                    <i>&#xf132;</i>Deleted Pay To/From Company<span>Deleted Pay To/From Company List</span></h1>
            ...
            <div class="data">
                ...
                <div class="widget">
                    <header class="widget-header">
                        ...
                        <h3 id="Header3" runat="server" class="widget-header-title">System Deleted Pay To/From Company List</h3>
                    </header>
                            ...
                            <div id="deletedListGridContainer">
                                <asp:GridView ID="deletedListGridView" runat="server" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="CompanyEmail" HeaderText="Company Email" />
                                        <asp:BoundField DataField="CompanyWeb" HeaderText="Company Website" />
