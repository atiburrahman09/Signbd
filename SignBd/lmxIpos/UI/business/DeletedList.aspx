<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true"
    CodeBehind="DeletedList.aspx.cs" Inherits="lmxIpos.UI.business.DeletedList" %>
    ...
    <asp:UpdatePanel runat="server" ID="UpdatePanel1" UpdateMode="Conditional" ChildrenAsTriggers="true">
        <ContentTemplate>
            <div class="title-sitemap grid-12">
                <h1 class="grid-6">
                    <i>&#xf132;</i>Deleted Business List<span>Deleted Business List</span></h1>
                ...
                <div class="widget">
                    <header class="widget-header">
                        ...
                        <h3 id="Header3" runat="server" class="widget-header-title">
                            Deleted Business List of System</h3>
                    </header>
                        ...
                        <div class="grid-12">
                            <div id="deletedListGridContainer">
                                <asp:GridView ID="deletedListGridView" runat="server" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="WarehouseId" HeaderText="Business ID" />
