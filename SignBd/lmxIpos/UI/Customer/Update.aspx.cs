    ...
    public partial class Update : System.Web.UI.Page
    {
        ...
        private void LoadWareHouses()
        {
            ...
            try
            {
                ...
                joiningSalesCenterDropDownList.DataValueField = "WarehouseId";
                joiningSalesCenterDropDownList.DataTextField = "WarehouseName";
                joiningSalesCenterDropDownList.DataBind();
                joiningSalesCenterDropDownList.Items.Insert(0, "Select please...");
                joiningSalesCenterDropDownList.Items[0].Value = "";
                // WarehouesDropDownL// WarehouesDropDownList.SelectedIndex = 0;
