    ...
    public partial class DeletedList : System.Web.UI.Page
    {
        ...
        protected void viewLinkButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                LumexSessionManager.Add("CustomerIdForView", deletedListGridView.Rows[row.RowIndex].Cells[0].Text.ToString());
                Response.Redirect("~/UI/Customer/View.aspx", false);
            }
            catch (Exception ex)
            {
                string message = ex.Message;
        ...
        protected void GetAllDeletedList()
        {
            ...
            try
            {
                ...
                DataTable dt = customer.GetDeletedCustomerListByDateRangeAll(fromDate, toDate, "All");
