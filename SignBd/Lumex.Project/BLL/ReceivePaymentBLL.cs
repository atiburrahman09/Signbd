...
namespace Lumex.Project.BLL
{
    public class ReceivePaymentBLL
    {
        ...
        public DataTable SaveVendorPayment(string accountOn, string whscId)
        {
            ReceivePaymentDAL receivePayment = new ReceivePaymentDAL();
            ...
            {
                LumexDBPlayer db = LumexDBPlayer.Start();
                DataTable dt = receivePayment.SaveVendorPayment(this, accountOn, whscId, db);
                db.Stop();
        ...
        public DataTable SaveCustomerPayment(string acountOn)
        {
            ReceivePaymentDAL receivePayment = new ReceivePaymentDAL();
            ...
            {
                LumexDBPlayer db = LumexDBPlayer.Start();
                DataTable dt = receivePayment.SaveCustomerPayment(this, acountOn,db);
                db.Stop();
